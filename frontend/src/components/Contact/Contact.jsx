...
const Contact = () => {
  return (
    <footer className="contactSection h-[100vh] md:h-[75vh] w-screen flex flex-col items-center">
      ...
      <div className="w-full h-[100vh] flex flex-col md:flex-row justify-evenly items-center px-20 bg-slate-100">
        <div className="w-1/2 h-full flex flex-col px-5">
          <h1 className="text-3xl font-semibold tracking-tighter text-[#072AC8] my-5">
            <a href="">BreastCare</a>
          </h1>
          <p className="text-[#404040] text-sm font-semibold">
        ...
        <div className="w-1/2 h-full px-5">
          ...
          <span className="font-semibold text-[#404040] cursor-pointer hover:underline">
